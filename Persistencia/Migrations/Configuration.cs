    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Persistencia.Contexts.EFContext>
    {
        ...
        protected override void Seed(Persistencia.Contexts.EFContext context)
        {
            ...
            Seguro Seguros = new Seguro()
            {
                ...
                CNPJ = "12354312354323",
                PrecoParcela = 250.00,
                Email = "AutoSeguros@auto.com.br",
                Telefone = "1253432343",
                DataContratacao = DateTime.ParseExact("07/30/2018", "MM/dd/yyyy", CultureInfo.InvariantCulture),
            ...
            Motorista Motorista1 = new Motorista()
            {
                ...
                CPF = "12345678911",
                Nome = "Antonio",
                NumeroCNH = "98712345684",
                MotoristaProprio = true,
                PontosCNH = 0,
            ...
            Motorista Motorista2 = new Motorista()
            {
                ...
                CPF = "12345558911",
                Nome = "Maria",
                NumeroCNH = "54376512343",
                MotoristaProprio = false,
                PontosCNH = 13,
                Estado = EstadosDeMotorista.REGULAR,
            ...
            Veiculo Veiculo1 = new Veiculo()
            {
                ...
                Tipo = TiposDeVeiculo.CARRO,
                Cor = "Vermelho",
                CodRenavam = "12398745682",
                Placa = "JDO2842",
                Modelo = "Gol",
                Marca = "Volksvagen",
                VeiculoId = 1,
            ...
            Veiculo Veiculo2 = new Veiculo()
            {
                ...
                Tipo = TiposDeVeiculo.VAN,
                Cor = "Branco",
                CodRenavam = "12378974582",
                Placa = "JKO2842",
                Modelo = "Transit",
                Marca = "Ford",
                VeiculoId = 2,
